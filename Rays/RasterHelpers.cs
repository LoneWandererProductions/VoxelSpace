...
public static class RasterHelpers
{
    ...
    public static PointF ProjectToScreen(Vector3 pos, int screenWidth, int screenHeight)
    {
        ...
        var x = (pos.X + 1f) * 0.5f * screenWidth;
        var y = (1f - (pos.Y + 1f) * 0.5f) * screenHeight; // Flip Y
    ...
    /// </summary>
    public static PointF[] ProjectQuad(Vector3 v0, Vector3 v1, Vector3 v2, Vector3 v3, Matrix4x4 vp, int screenWidth,
        int screenHeight)
    {
        return new[]
        {
